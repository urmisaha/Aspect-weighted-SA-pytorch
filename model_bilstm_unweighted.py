...
print("unweighted - only hidden - negative downsampled - 2341")
    ...
    for inputs, labels in train_loader:
        ...
        if counter%print_every == 0:
            ...
            if np.mean(val_losses) < valid_loss_min:
                torch.save(model.state_dict(), 'models/state_dict_val_unweighted_upsample2341.pt')
...
# trained_scores_dict = {}
# f = open('unweighted_trained.csv', 'w+')
...
model.load_state_dict(torch.load('models/state_dict_val_unweighted_upsample2341.pt'))
...
print("num_layers=1 - unweighted - only hidden - downsampled - 2341")
