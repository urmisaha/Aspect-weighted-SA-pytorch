    ...
    for inputs, labels in train_loader:
        ...
        if counter%print_every == 0:
            ...
            if np.mean(val_losses) < valid_loss_min:
                torch.save(model.state_dict(), 'models/' + domain + '/awsa_random' + weighted + '_' + dataamount + '_' + str(seed) + '.pt')
...
model.load_state_dict(torch.load('models/' + domain + '/awsa_random' + weighted + '_' + dataamount + '_' + str(seed) + '.pt'))
